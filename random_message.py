...
if random.random() < 0.9:
    messages = [
        "<@1014296748623155200> t’es ma petite salope … envoie un BC si t’es un homme!",
        "<@1014296748623155200> t’es ma petite salope … envoie un BC si t’es un",
        "<@1014296748623155200> t’es ma petite salope … envoie un BC si t’es",
        "<@1014296748623155200> t’es ma petite salope … envoie un BC si",
        "<@1014296748623155200> t’es ma petite salope … envoie un BC",
        "<@1014296748623155200> t’es ma petite salope … envoie un"
    ]
